...
export const getSnsrList = (page, sizePerPage, searchItem) =>
   axios.get(`${API_ROOT}/snsrs?page=${page}&size=${sizePerPage}&searchWrd=${searchItem.searchWrd}&areaCode=${searchItem.areaCode}&levelAreaCode=${searchItem.levelAreaCode}&delYn=${searchItem.delYn}`);
