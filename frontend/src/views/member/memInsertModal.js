...
const MemInsertModal = props => {
  ...
  const {register, handleSubmit, formState: {errors}, reset, setValue, setFocus, getValues, setError } =
    useForm({defaultValues: {useYn: "Y", memIsLeave: "N", memRcvSms: "Y", delYn: "N", groupUse: "N"}, mode: "all"});
        ...
        <CModalBody>
          ...
          <CFormGroup row>
            <CCol md={"12"}>
              ...
              <textarea className={"form-control textarea-height"} id={"memMemo"} rows={"12"} placeholder={"메모를 입력해주세요."}
                        {...register("memMemo")} />
            </CCol>
          </CFormGroup>
        </CModalBody>
