package kr.fscom.firsens.common.paging;
...
public class PaginationInfo {
    ...
    private static final Logger LOG = LoggerFactory.getLogger(PaginationInfo.class);
    ...
    public PaginationInfo getPaginationInfo(HashMap<String, Object> map) throws Exception {
        try {
            PaginationInfo pInfo = new PaginationInfo();
            pInfo.setPageSize((int) map.get("pageSize"));
            pInfo.setRecordCountPerPage((int) map.get("recordCountPerPage"));
            pInfo.setCurrentPageNo((int) map.get("currentPageNo"));
            pInfo.setTotalRecordCount((int) map.get("totalRecordCount"));

            return pInfo;
        } catch (NullPointerException | IllegalFormatException | NumberFormatException e) {
