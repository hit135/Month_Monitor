...
public interface MCDistrictRepo {
    ...
    List<HashMap<String, Object>> LIST_MCD_CURR_GRP_MAP_EVENT_STAT() throws Exception;           // 지도 구별 설치 센서수와 이벤트 발생 건수
    List<HashMap<String, Object>> LIST_MCD_MONTHLY_GRP_EVENT_COMP_STAT() throws Exception;       // 구별 전월대비 주의 경고 발생 건수
    List<HashMap<String, Object>> LIST_MCD_TODAY_GRP_AREA_EVENT_COMP_RANK() throws Exception;    // 구별 시장별 금일 누적 경보 랭크
    List<HashMap<String, Object>> LIST_MCD_TODAY_GRP_EVENT() throws Exception;                   // 구별 금일 누적 경보 랭크
