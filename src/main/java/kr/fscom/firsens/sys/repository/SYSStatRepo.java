...
public interface SYSStatRepo {
    ...
    List<HashMap<String, Object>> LIST_TYPE_GRPCODE() throws Exception;
    List<HashMap<String, Object>> LIST_TYPE_AREACODE() throws Exception;

    List<HashMap<String, Object>> LIST_SYS_STAT_GRP_INFO_STAT(String grpCode) throws Exception;
    HashMap<String, Object> SELECT_SYS_STAT_AREA_INFO_STAT(String areaCode) throws Exception;
    HashMap<String, Object> SELECT_SYS_STAT_GRP_INFO_STAT(String grpCode) throws Exception;
    ...
    HashMap<String, Object> SELECT_SYS_STAT_GRP_KWHIGO_STAT(HashMap<String, Object> map) throws Exception;
    ...
    List<HashMap<String, Object>> LIST_SYS_STAT_LEVEL_GRP_STAT(HashMap<String, Object> map) throws Exception;
    List<HashMap<String, Object>> LIST_SYS_STAT_STR_GRP_EVENT_STAT(HashMap<String, Object> map) throws Exception;
    List<HashMap<String, Object>> LIST_SYS_STAT_STR_KWH_STAT(HashMap<String, Object> map) throws Exception;
    List<HashMap<String, Object>> LIST_SYS_STAT_STR_GRP_KWH_STAT(HashMap<String, Object> map) throws Exception;
    List<HashMap<String, Object>> LIST_SYS_STAT_AREA_GRP_KWH_STAT(HashMap<String, Object> map) throws Exception;
